...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/WizardAcceleo/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
         ...
         */
         if(!isInWorkspace(WizardPackage.class))
        	 resourceSet.getPackageRegistry().put(WizardPackage.eNS_URI, WizardPackage.eINSTANCE);
    }
