...
/**
 * This is the item provider adapter for a {@link wizard.Wizard} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WizardItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WizardPackage.Literals.WIZARD__TITLE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Wizard.class)) {
			case WizardPackage.WIZARD__TITLE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WizardPackage.Literals.WIZARD__PAGES,
				 WizardFactory.eINSTANCE.createPage()));
	}
