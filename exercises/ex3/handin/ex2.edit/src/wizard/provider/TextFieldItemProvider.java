...
/**
 * This is the item provider adapter for a {@link wizard.TextField} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextFieldItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextField_minLength_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TextField_minLength_feature", "_UI_TextField_type"),
				 WizardPackage.Literals.TEXT_FIELD__MIN_LENGTH,
				 true,
				 false,
				 false,
	...
	protected void addMaxLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextField_maxLength_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TextField_maxLength_feature", "_UI_TextField_type"),
				 WizardPackage.Literals.TEXT_FIELD__MAX_LENGTH,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WizardPackage.Literals.TEXT_FIELD__INPUT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WizardPackage.Literals.TEXT_FIELD__LABEL);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_TextField_type") + " " + textField.getMinLength();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WizardPackage.Literals.TEXT_FIELD__LABEL,
